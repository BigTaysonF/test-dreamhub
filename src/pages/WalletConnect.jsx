                ...
                <div className="themesflat-container">
                    ...
                    <div className="col-xl-4 col-md-12">
                        ...
                        <h2 className="tf-title-heading ct style-2 mg-bt-12">
                            ...
                            Choose one of available wallet providers or create a new wallet. What is a wallet?
                            </h5>
                                <div className="buttons-c">
                                    <div className="sc-btn-top2 mg-r-12" id="site-header">
                                        ...
                                        <img src="../assets/images/icon/connect-1.png" alt="" />
                                        <span>Meta Mask</span>
                                        </Link>
                                    </div>
                                    <div className="sc-btn-top2 mg-r-12" id="site-header">
                                        <Link to="/wallet-connect" className="sc-button style-1 pri-1"><span>Meta Mask
                                        </span></Link>
                                    </div>
                                    <div className="sc-btn-top2 mg-r-12" id="site-header">
                                        <Link to="/wallet-connect" className="sc-button style-1 pri-1"><span>Meta Mask
